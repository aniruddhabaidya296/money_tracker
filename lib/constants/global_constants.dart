class GlobalConstants {
  ...
  static String valueColumn = "valueColumn";
  static String typeColumn = "typeColumn";
  static String descriptionColumn = "descriptionColumn";
  static String given = "g";
  static String taken = "t";
}
